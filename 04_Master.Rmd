...
<br>
  ...
  >*Answer 1:* As time progresses, Fynbos greenness eventually saturates due to the decline in rainfall, thus causing the post fire recovery rate to decrease due to the deterioration of the fynbos shrubs causing the NDVI to reduce and saturate.
  <br>
...
Q2: How do the estimates for the common parameters compare?
  ...
  >*Answer 2:* The parameter estimates for alpha and lambda are higher in the simple model than the full model whilsts the gamma estimate is lower simple model than than the full model.
...
<br>
  ...
  >*Answer 3:* Model 2 as it has a p value < 0.001 with the addition of the 2 parameters thus showing model 2 is a better modle.
  
  Q4: How many degrees of freedom are there in this ANOVA and why (i.e. what are they)?
  
  >*Answer 4:* 2 degrees of freedom because the 2 parameters that differ model 1 and 2 are A and pi.
...
>*Answer 5:* Yes, the full model as it has a lower AIC value.
...
?AIC
>*Answer 6:* AIC requires models fitted by maximum likelihood in order to compare AIC values between models and determine which model is the better fit. However, NLS models are not fitted by maximum likelihood but by non linear least squares estimation. Therefore, AIC values of NLS models cannot be compared.
